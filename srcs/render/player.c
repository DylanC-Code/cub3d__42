...
/*   Updated: 2025/08/18 14:23:19 by dcastor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	render_vue_line(t_game *game)
{
	...
	start.x = game->player.pos.x * TILE_SIZE + 4;
	start.y = game->player.pos.y * TILE_SIZE + 4;
...
void	render_player(t_game *game)
{
	...
	player_off.x = game->player.pos.x * TILE_SIZE;
	player_off.y = game->player.pos.y * TILE_SIZE;
